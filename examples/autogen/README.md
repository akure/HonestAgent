# AutoGen/AG2 adapter example

This is a **credential-free local adapter example** for AutoGen/AG2. It demonstrates the framework boundary without installing or claiming compatibility with every framework release. The wrapper delegates to `honest_agent.adapters.GuardedFrameworkTool`; it does not duplicate policy logic.
